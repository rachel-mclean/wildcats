...
async function main() {
  let url = 'https://davidsonwildcats.com/sports/womens-swimming-and-diving/roster';
  ...
  //    await knex('womens_swimming_players').insert(player);
  //  }
